...
class MainTest(unittest.TestCase):
    ...
    def simul_undulator_near_to_farfield(self,und_test, method_traj,formule):
    ...
    def test_main(self):
        ...
        self.simul_undulator_near_to_farfield(und_test=und_test,
        ...
        self.simul_undulator_near_to_farfield(und_test=ESRF18,
                                                         method_traj=TRAJECTORY_METHOD_ANALYTIC, formule=1)
        print("TRAJECTORY_METHOD_ANALYTIC ok")
