...
class TrajectoryFactoryTest(unittest.TestCase):
    ...
    def test_create_trajectory(self):
        ...
        B=und_test.create_magnetic_field_plane_undulator(Z=traj_test.t*codata.c,Y=0.0,harmonic_number=1)
        traj_test2 = fact_test2.create_for_plane_undulator( undulator=und_test,B=B)
